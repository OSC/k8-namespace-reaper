...
bump-version:
	...
	@yq -i e '.version = "$(VERSION)"' charts/k8-namespace-reaper/Chart.yaml
	@yq -i e '.appVersion = "$(VERSION)"' charts/k8-namespace-reaper/Chart.yaml
	@git add charts/k8-namespace-reaper/Chart.yaml
